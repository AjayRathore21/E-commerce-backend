...
const uri =
  "mongodb+srv://ajaykumar420ak79:nXscU4f8KY3uIIle@cluster0.r2ptxru.mongodb.net/?retryWrites=true&w=majority";
...
const data =  {
    "products": [
      ...
      {
        "title": "iphone X -2 by me",
        "description": "iphone 16 my phone",
        "brand": "Apple",
        "category": "smartphones",
        "price": 1000,
        ...
        "addresses": [
          {
            ...
            "state": "Haryana",
            "pinCode": "131404",
            "street": "Vill. Garhi bala, near bindhroli",
            "phone": "09992664018"
          },
          {
            "name": "Ajay",
...
async function uploadData() {
  ...
  try {
    ...
    await insertDocuments(db, "products", data.products);
    await insertDocuments(db, "brands", data.brands);
    await insertDocuments(db, "categories", data.categories);
    await insertDocuments(db, "users", data.users);
    await insertDocuments(db, "cart", data.cart);
    await insertDocuments(db, "orders", data.orders);
